    ...
    <div id='tasklist' className='h-[55%] overflow-x-auto flex items-center justify-start gap-5 flex-nowrap w-full py-5 mt-10'>
        <div className='flex-shrink-0 h-full w-[350px] p-5 bg-red-400 rounded-xl'>
            ...
            <p className='text-sm mt-2'>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Provident, quae accusamus debitis dolor omnis maxime.
            </p>
        </div>
        <div className='flex-shrink-0 h-full w-[350px] p-5 bg-green-400 rounded-xl'>
            ...
            <h2 className='mt-5 text-2xl font-semibold'>Make a youtube video</h2>
            <p className='text-sm mt-2'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Provident, quae accusamus debitis dolor omnis maxime.</p>
        </div>
